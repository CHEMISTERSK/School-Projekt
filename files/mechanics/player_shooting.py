...
class PlayerProjectile:
    ...
    def draw(self, screen, camera_x, camera_y):
        ...
        rotated_shell = pygame.transform.rotate(data.green_shell, -angle_degrees)
        shell_rect = rotated_shell.get_rect(center=(int(draw_x), int(draw_y)))
...
class PlayerShooting:
    ...
    def shoot(self, tank_x, tank_y, mouse_x, mouse_y, mouse_clicked):
        ...
        elif current_time - self.last_shot_time >= 0 and not self.reload_sound_played:
